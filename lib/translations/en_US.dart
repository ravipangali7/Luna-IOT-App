class EnUs {
  static const Map<String, String> translations = {
    ...
    // Fleet Management
    'servicing_records': 'Servicing Records',
    'expenses_records': 'Expenses Records',
    'fuel_ev_expenses': 'Fuel/EV Expenses',
    'documents': 'Documents',
    'add_servicing': 'Add Servicing',
    'edit_servicing': 'Edit Servicing',
    'add_expense': 'Add Expense',
    'edit_expense': 'Edit Expense',
    'add_energy_cost': 'Add Energy Cost',
    'edit_energy_cost': 'Edit Energy Cost',
    'add_document': 'Add Document',
    'edit_document': 'Edit Document',
    'select_vehicle': 'Select Vehicle',
    'select_vehicle_first': 'Please select a vehicle first',
    ...
    'expenses_type_required': 'Expenses type is required',
    'part': 'Part',
    'fine': 'Fine',
    'part_expire_month': 'Part Expire Month',
    'energy_type': 'Energy Type',
    'energy_type_required': 'Energy type is required',
    'fuel': 'Fuel',
    'electric': 'Electric',
    'total_unit': 'Total Unit',
    'total_unit_required': 'Total unit is required',
    'liters': 'Liters',
    'kwh': 'kWh',
    'last_expire_date': 'Last Expire Date',
    'expire_in_month': 'Expire In Month',
    'expire_in_month_required': 'Expire in month is required',
    'months': 'Months',
    'expire_date': 'Expire Date',
    'no_servicing_records': 'No servicing records',
    'no_expenses_records': 'No expenses records',
    'no_energy_cost_records': 'No energy cost records',
    'no_documents_records': 'No documents records',
    'servicing_added': 'Servicing added successfully',
    'servicing_updated': 'Servicing updated successfully',
    'servicing_deleted': 'Servicing deleted successfully',
    'expense_added': 'Expense added successfully',
    'expense_updated': 'Expense updated successfully',
    'expense_deleted': 'Expense deleted successfully',
    'energy_cost_added': 'Energy cost added successfully',
    'energy_cost_updated': 'Energy cost updated successfully',
    'energy_cost_deleted': 'Energy cost deleted successfully',
    'document_added': 'Document added successfully',
    'document_updated': 'Document updated successfully',
    'document_deleted': 'Document deleted successfully',
    'document_renewed': 'Document renewed successfully',
    'delete_servicing': 'Delete Servicing',
    'confirm_delete_servicing': 'Are you sure you want to delete this servicing record?',
    'delete_expense': 'Delete Expense',
    'confirm_delete_expense': 'Are you sure you want to delete this expense record?',
    'delete_energy_cost': 'Delete Energy Cost',
    'confirm_delete_energy_cost': 'Are you sure you want to delete this energy cost record?',
    'delete_document': 'Delete Document',
    'confirm_delete_document': 'Are you sure you want to delete this document?',
    'renew_document': 'Renew Document',
    'confirm_renew_document': 'Are you sure you want to renew this document?',
    'renew': 'Renew',
    ...
    'units': 'Units',
    'vehicle': 'Vehicle',
    'select_date_range_and_generate': 'Select date range and generate report',
    'report_feature_coming_soon': 'Report feature coming soon',
    'manage_vehicle_servicing_timeline': 'Manage vehicle servicing timeline',
    'manage_vehicle_expenses_records': 'Manage vehicle expenses records',
    'manage_fuel_ev_expenses': 'Manage Fuel/EV expenses',
    'vehicle_documents': 'Vehicle Documents',
    'generate_detailed_fleet_reports': 'Generate detailed fleet reports',
    'document_image_one': 'Document Image One',
    'document_image_two': 'Document Image Two',
