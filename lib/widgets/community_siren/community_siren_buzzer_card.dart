...
class CommunitySirenBuzzerCard extends StatelessWidget {
  final CommunitySirenBuzzer buzzer;

  const CommunitySirenBuzzerCard({super.key, required this.buzzer});
  ...
  Widget build(BuildContext context) {
    final status = buzzer.buzzerStatus;
    ...
    return Column(
      children: [
        // Institute Badge
        if (buzzer.instituteLogo != null || buzzer.instituteName.isNotEmpty)
          Container(
            ...
            child: Row(
              ...
              children: [
                if (buzzer.instituteLogo != null) ...[
                  ClipRRect(
                    borderRadius: BorderRadius.circular(4),
                    child: Image.network(
                      buzzer.instituteLogo!,
                      width: 20,
                      height: 20,
                      fit: BoxFit.cover,
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              // Header: Buzzer Title and Device
              Row(
                ...
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      color: status != null && status.relay
