...
class ExpensesCreateScreen extends StatefulWidget {
  const ExpensesCreateScreen({super.key});

  @override
  State<ExpensesCreateScreen> createState() => _ExpensesCreateScreenState();
}

class _ExpensesCreateScreenState extends State<ExpensesCreateScreen> {
  final _formKey = GlobalKey<FormState>();
  final _titleController = TextEditingController();
  final _amountController = TextEditingController();
  final _dateController = TextEditingController();
  final _partExpireMonthController = TextEditingController();
  final _remarksController = TextEditingController();
  
  final Rx<Vehicle?> selectedVehicle = Rx<Vehicle?>(null);
  final RxString selectedExpensesType = 'part'.obs;
  ...
  Future<void> _submitForm(FleetManagementController controller) async {
    ...
    try {
      ...
      await expensesApiService.createVehicleExpense(
      ...
      Get.back();
      Get.snackbar('success'.tr, 'expense_added'.tr);
    } catch (e) {
