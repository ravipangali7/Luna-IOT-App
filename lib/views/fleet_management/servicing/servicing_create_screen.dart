...
class ServicingCreateScreen extends StatefulWidget {
  const ServicingCreateScreen({super.key});

  @override
  State<ServicingCreateScreen> createState() => _ServicingCreateScreenState();
}

class _ServicingCreateScreenState extends State<ServicingCreateScreen> {
  ...
  Future<void> _submitForm(FleetManagementController controller) async {
    ...
    try {
      ...
      await servicingApiService.createVehicleServicing(
      ...
      Get.back();
      Get.snackbar('success'.tr, 'servicing_added'.tr);
    } catch (e) {
