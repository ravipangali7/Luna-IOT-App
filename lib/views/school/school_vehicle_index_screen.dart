...
class SchoolVehicleIndexScreen extends GetView<VehicleController> {
  const SchoolVehicleIndexScreen({super.key});
  ...
  void _showSearchFilterBottomSheet() {
    ...
    Get.bottomSheet(
      SearchFilterBottomSheet(
        ...
        onSearchChanged: controller.updateSearchQueryForSchool,
        onFilterChanged: controller.updateFilter,
        onClearAll: controller.clearAllFiltersForSchool,
        onApply: () => Get.back(),
      ),
  ...
  Widget build(BuildContext context) {
    ...
    // Always load school vehicles on screen open, clearing existing vehicles first
    WidgetsBinding.instance.addPostFrameCallback((_) {
      if (!controller.paginationLoading.value) {
        // Clear existing vehicles to ensure clean state
        controller.vehicles.clear();
        controller.filteredVehicles.clear();
        controller.currentPage.value = 1;
        // Load school vehicles
        controller.loadSchoolVehiclesPaginated();
      }
    });
    return Scaffold(
      // Appbar
                ...
                itemBuilder: (context, index) {
                  ...
                  return Container(
                    ...
                    child: FilterChip(
                      ...
                      onSelected: (selected) {
                        if (selected) {
                          controller.setFilterForSchool(filter);
                        }
                      },
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      if (controller.selectedFilter.value != 'All') ...[
                        ...
                        TextButton(
                          onPressed: () => controller.setFilterForSchool('All'),
                          child: Text(
                ...
                children: [
                  Expanded(
                    child: Stack(
                      children: [
                        RefreshIndicator(
                          onRefresh: () => controller.loadSchoolVehiclesPaginated(),
                          child: Padding(
                  ...
                  Obx(
                    () => CompactPaginationWidget(
                      ...
                      onPrevious: controller.previousPageForSchool,
                      onNext: controller.nextPageForSchool,
                    ),
                  ),
                ],
              );
